...
namespace WebApplicationMVC.Areas.Identity.Pages.Account.Manage
{
    public class TwoFactorAuthenticationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            TempData.Put("StatusMessage", new StatusMessageViewModel("The current browser has been forgotten. When you login again from this browser you will be prompted for your 2fa code.", StatusType.Success));
